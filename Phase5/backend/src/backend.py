...
class Backend:
    ...
    def set_merged_daily_transactions(self) -> None:
        ...
        read_files = glob.glob(os.path.join(self.current_dir, "..", "database", "Daily_Transactions", "*.txt"))
        merged_transactions_file = os.path.join(self.current_dir, "..", "database", "Merged_Daily_Transaction.txt")
        with open(merged_transactions_file, "w+") as outfile:
            for f in read_files:
        ...
        file = open(merged_transactions_file, "r")
        for line in file:
    ...
    def write_new_available_users(self) -> None:
        new_users_file = os.path.join(self.current_dir, "..", "database", "New_Current_User_Accounts.txt")
        file = open(new_users_file, "w")
    ...
    def write_new_available_items(self) -> None:
        new_items_file = os.path.join(self.current_dir, "..", "database", "New_Available_Items.txt")
        file = open(new_items_file, "w")
